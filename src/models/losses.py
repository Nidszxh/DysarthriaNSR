...
class BlankPriorKLLoss(nn.Module):
    ...
    a clinically-motivated target (default 0.30 — roughly the ratio of silence
    frames to phoneme frames in continuous speech CTC outputs). Uses KL divergence
    ...
    Args:
        ...
        target_prob: Target mean blank probability. Default 0.30.
    """

    def __init__(self, blank_id: int = 0, target_prob: float = 0.30):
        super().__init__()
